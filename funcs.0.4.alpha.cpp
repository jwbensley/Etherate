...
void print_usage () {
    ...
    printf ("Usage info; [Mode] [Destination] [Source] [Options] [Other]\n"
            ...
            "\t\t-d 11:22:33:44:55:66\n"
            "[Source] Source interface and MAC address\n"
            ...
            "[Other] Misc options and additional test parameters\n"
            ...
            fSizeDef, (fSizeDef+headersLength), fDurationDef, fCountDef, fBytesDef);
